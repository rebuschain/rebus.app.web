...
goog.exportSymbol('proto.rebus.nftid.v1.MsgDeactivateNftId', null, global);
goog.exportSymbol('proto.rebus.nftid.v1.MsgDeactivateNftIdResponse', null, global);
 ...
 * @constructor
 */
proto.rebus.nftid.v1.MsgActivateNftId = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.rebus.nftid.v1.MsgActivateNftId, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.rebus.nftid.v1.MsgActivateNftId.displayName = 'proto.rebus.nftid.v1.MsgActivateNftId';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.rebus.nftid.v1.MsgActivateNftIdResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.rebus.nftid.v1.MsgActivateNftIdResponse.displayName = 'proto.rebus.nftid.v1.MsgActivateNftIdResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.rebus.nftid.v1.MsgDeactivateNftId = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.rebus.nftid.v1.MsgDeactivateNftId, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.rebus.nftid.v1.MsgDeactivateNftId.displayName = 'proto.rebus.nftid.v1.MsgDeactivateNftId';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.rebus.nftid.v1.MsgDeactivateNftIdResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.displayName = 'proto.rebus.nftid.v1.MsgDeactivateNftIdResponse';
}
 ...
 * @return {!Object}
 */
proto.rebus.nftid.v1.MsgActivateNftId.prototype.toObject = function(opt_includeInstance) {
  return proto.rebus.nftid.v1.MsgActivateNftId.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.rebus.nftid.v1.MsgActivateNftId} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rebus.nftid.v1.MsgActivateNftId.toObject = function(includeInstance, msg) {
  var f, obj = {
    address: jspb.Message.getFieldWithDefault(msg, 1, ""),
    nftType: jspb.Message.getFieldWithDefault(msg, 2, 0),
    organization: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.rebus.nftid.v1.MsgActivateNftId}
 */
proto.rebus.nftid.v1.MsgActivateNftId.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.rebus.nftid.v1.MsgActivateNftId;
  return proto.rebus.nftid.v1.MsgActivateNftId.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.rebus.nftid.v1.MsgActivateNftId} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.rebus.nftid.v1.MsgActivateNftId}
 */
proto.rebus.nftid.v1.MsgActivateNftId.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.rebus.nftid.v1.MsgActivateNftId.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.rebus.nftid.v1.MsgActivateNftId.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.rebus.nftid.v1.MsgActivateNftId} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rebus.nftid.v1.MsgActivateNftId.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAddress();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.rebus.nftid.v1.MsgActivateNftId.prototype.getAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.rebus.nftid.v1.MsgActivateNftId.prototype.setAddress = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!proto.rebus.nftid.v1.NftId}
 */
proto.rebus.nftid.v1.MsgActivateNftId.prototype.getNftType = function() {
  return /** @type {!proto.rebus.nftid.v1.NftId} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.rebus.nftid.v1.MsgActivateNftId} returns this
 */
proto.rebus.nftid.v1.MsgActivateNftId.prototype.setNftType = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.rebus.nftid.v1.MsgActivateNftId.prototype.getOrganization = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.rebus.nftid.v1.MsgActivateNftId} returns this
 */
proto.rebus.nftid.v1.MsgActivateNftId.prototype.setOrganization = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.rebus.nftid.v1.MsgActivateNftIdResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.rebus.nftid.v1.MsgActivateNftIdResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    idRecord: (f = msg.getIdRecord()) && rebus_nftid_v1_id_pb.IdRecord.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.rebus.nftid.v1.MsgActivateNftIdResponse}
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.rebus.nftid.v1.MsgActivateNftIdResponse;
  return proto.rebus.nftid.v1.MsgActivateNftIdResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.rebus.nftid.v1.MsgActivateNftIdResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.rebus.nftid.v1.MsgActivateNftIdResponse}
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.rebus.nftid.v1.MsgActivateNftIdResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.rebus.nftid.v1.MsgActivateNftIdResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getIdRecord();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.rebus.nftid.v1.IdRecord}
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.prototype.getIdRecord = function() {
  return /** @type{?proto.rebus.nftid.v1.IdRecord} */ (
    jspb.Message.getWrapperField(this, rebus_nftid_v1_id_pb.IdRecord, 1));
};
...
/**
 * @param {?proto.rebus.nftid.v1.IdRecord|undefined} value
 * @return {!proto.rebus.nftid.v1.MsgActivateNftIdResponse} returns this
*/
proto.rebus.nftid.v1.MsgActivateNftIdResponse.prototype.setIdRecord = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.rebus.nftid.v1.MsgActivateNftIdResponse} returns this
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.prototype.clearIdRecord = function() {
  return this.setIdRecord(undefined);
};
 ...
 * @return {boolean}
 */
proto.rebus.nftid.v1.MsgActivateNftIdResponse.prototype.hasIdRecord = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.prototype.toObject = function(opt_includeInstance) {
  return proto.rebus.nftid.v1.MsgDeactivateNftId.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.rebus.nftid.v1.MsgDeactivateNftId} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.toObject = function(includeInstance, msg) {
  var f, obj = {
    address: jspb.Message.getFieldWithDefault(msg, 1, ""),
    nftType: jspb.Message.getFieldWithDefault(msg, 2, 0),
    organization: jspb.Message.getFieldWithDefault(msg, 3, "")
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftId}
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.rebus.nftid.v1.MsgDeactivateNftId;
  return proto.rebus.nftid.v1.MsgDeactivateNftId.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.rebus.nftid.v1.MsgDeactivateNftId} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftId}
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.rebus.nftid.v1.MsgDeactivateNftId.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.rebus.nftid.v1.MsgDeactivateNftId} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAddress();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.prototype.getAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftId} returns this
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.prototype.setAddress = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!proto.rebus.nftid.v1.NftId}
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.prototype.getNftType = function() {
  return /** @type {!proto.rebus.nftid.v1.NftId} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftId} returns this
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.prototype.setNftType = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.prototype.getOrganization = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftId} returns this
 */
proto.rebus.nftid.v1.MsgDeactivateNftId.prototype.setOrganization = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.rebus.nftid.v1.MsgDeactivateNftIdResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    idRecord: (f = msg.getIdRecord()) && rebus_nftid_v1_id_pb.IdRecord.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftIdResponse}
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.rebus.nftid.v1.MsgDeactivateNftIdResponse;
  return proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.rebus.nftid.v1.MsgDeactivateNftIdResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftIdResponse}
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.rebus.nftid.v1.MsgDeactivateNftIdResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getIdRecord();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.rebus.nftid.v1.IdRecord}
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.prototype.getIdRecord = function() {
  return /** @type{?proto.rebus.nftid.v1.IdRecord} */ (
    jspb.Message.getWrapperField(this, rebus_nftid_v1_id_pb.IdRecord, 1));
};
...
/**
 * @param {?proto.rebus.nftid.v1.IdRecord|undefined} value
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftIdResponse} returns this
*/
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.prototype.setIdRecord = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.rebus.nftid.v1.MsgDeactivateNftIdResponse} returns this
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.prototype.clearIdRecord = function() {
  return this.setIdRecord(undefined);
};
 ...
 * @return {boolean}
 */
proto.rebus.nftid.v1.MsgDeactivateNftIdResponse.prototype.hasIdRecord = function() {
  return jspb.Message.getField(this, 1) != null;
};
