...
import './index.scss';
import { fetchVoteDetails, hideProposalDialog } from 'src/actions/proposals';
...
class ProposalDialog extends Component {
	...
	VoteCalculation(val) {
		...
		if (proposal.status === 2) {
			...
			return this.props.tallyDetails &&
				this.props.tallyDetails[proposal.id] &&
				this.props.tallyDetails[proposal.id][val]
				? tally(this.props.tallyDetails[proposal.id][val], sum)
				: '0%';
		} else {
			const sum =
		...
		this.props.proposalDetails &&
			...
			Object.keys(this.props.proposalDetails).filter(key => {
				if (key === this.props.proposal.id) {
					if (
						this.props.proposalDetails[key] &&
				...
				<div className="proposal_dialog padding">
					<div className="content">
						...
						<div className="proposal_dialog_section1">
							<div className="proposal_dialog_section1_header">
								{this.props.proposal &&
									this.props.proposal.content &&
									this.props.proposal.content.value &&
							...
							<div
								...
								{' '}
								Proposal Status: &nbsp;
								{this.props.proposal && this.props.proposal.status
					...
					<div className="pool content">
						<div className="proposal_dialog_section2">
							...
							<div className="proposal_dialog_section2_more" onClick={this.handleChange}>
							...
							<div className="proposal_dialog_section3_left">
								...
								<div className="pds3l_c">
									...
									<p className="pds3l_c2">
										{this.props.proposal && this.props.proposal.submit_time
											? moment(this.props.proposal.submit_time).format('DD-MMM-YYYY HH:mm:ss')
											: ''}
									</p>
								</div>
								<div className="pds3l_c">
									...
									<div className="pds3l_c2 vp_cards">
										<p>
											{this.props.proposal && this.props.proposal.voting_start_time
												? moment(this.props.proposal.voting_start_time).format('DD-MMM-YYYY HH:mm:ss')
												: ''}
										</p>
										<p>
											{this.props.proposal && this.props.proposal.voting_end_time
												? moment(this.props.proposal.voting_end_time).format('DD-MMM-YYYY HH:mm:ss')
												: ''}
										</p>
									</div>
								</div>
