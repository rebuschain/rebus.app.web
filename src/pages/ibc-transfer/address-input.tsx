			...
			{isEditing ? (
				<>
					...
					<div className="flex space-between">
						<div className="flex mt-2 mb-1 mr-3 items-center">
							{onGetKeplAddress && (
								<Button
									onClick={onGetKeplAddress}
									backgroundStyle="gradient-blue"
									className="h-8 py-1.5 px-2 flex md:static whitespace-nowrap"
							...
							{onGetMetamaskAddress && (
								<Button
									...
									backgroundStyle="gradient-blue"
									className="h-8 ml-2 p-1.5 pr-2 py-0.5 flex md:static whitespace-nowrap">
