...
import { DisplayIcon } from 'src/components/layouts/sidebar/sidebar-item';
...
import {
	...
	colorWhiteFaint,
	colorWhiteHigh,
} from 'src/emotion-styles/colors';
import { useBooleanStateWithWindowEvent } from 'src/hooks/use-boolean-state-with-window-event';
import { SlippageStep } from 'src/pages/main/models/trade-models';
	...
	return (
		<TradeTxSettingsContainer>
			<DisplayIcon
				...
				iconSelected="/public/assets/icons/setting-selected.svg"
			/>
