...
import { colorPrimary, colorPrimaryLight } from 'src/emotion-styles/colors';
import { cssRaiseButtonShadow } from 'src/emotion-styles/forms';
import { useFakeFeeConfig } from 'src/hooks/tx';
import { Clip } from 'src/pages/main/components/trade-clipboard/clip';
import { useStore } from 'src/stores';
import { useTradeConfig } from '../../hooks/use-trade-config';
import { SwapButton } from '../swap-button';
import { TradeTxSettings } from './trade-tx-settings';
