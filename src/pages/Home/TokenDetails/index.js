...
import totalTokens from 'src/assets/userDetails/totalTokens.png';
import stakedTokens from 'src/assets/userDetails/stakedTokens.png';
import unStake from 'src/assets/userDetails/unstake.png';
...
const TokenDetails = props => {
	...
	const balance =
		props.balance && props.balance.length && props.balance.find(val => val.denom === config.COIN_MINIMAL_DENOM);
		...
		<div className="token_details">
			<div className="chip_info">
				...
				<div className="chip">
					...
					{props.balanceInProgress ? <DotsLoading /> : <p>{available / 10 ** config.COIN_DECIMALS}</p>}
				</div>
				<StakeTokensButton />
			</div>
			<div className="chip_info">
				...
				<div className="chip">
					...
					{props.delegationsInProgress ? <DotsLoading /> : <p>{staked / 10 ** config.COIN_DECIMALS}</p>}
				</div>
			...
			<div className="chip_info">
				...
				<div className="chip">
					...
					{props.rewardsInProgress ? <DotsLoading /> : <p>{rewards > 0 ? rewards.toFixed(4) : 0}</p>}
				</div>
				<div className="buttons_div">
			...
			<div className="chip_info">
				...
				<div className="chip">
					...
					{props.unBondingDelegationsInProgress ? <DotsLoading /> : <p>{unStaked / 10 ** config.COIN_DECIMALS}</p>}
				</div>
			</div>
		</div>
	);
