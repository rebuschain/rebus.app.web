...
import { showClaimRewardsDialog } from 'src/actions/stake';
...
const ClaimButton = props => {
	...
	return (
		<Button className="btn gradient-blue claim" disabled={props.disable} variant="outlined" onClick={handleClick}>
